...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap disabled:text-muted-foreground border border-neutral-200 shadow-sm rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
